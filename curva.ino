...
const char* ssid = "TenZor";   // Вводим сюда SSID
const char* password = "4974582Ez";  //Вводим пароль
...
ptr +=".coo-icon{background-color: #10aa10;width: 30px;height: 30px;border-radius: 50%;line-height: 85px;}\n";
 
ptr +=".coo-text{font-weight: 600;padding-left: 15px;font-size: 19px;width: 160px;text-align: left;}\n";
 
ptr +=".coo{font-weight: 300;font-size: 60px;color: #10aa10;}\n";
...
ptr +=".superscript-coo{font-size: 17px;font-weight: 600;position: absolute;right: -55px;top: 15px;}\n";
...
ptr +="<div class=\"side-by-side coo-text\">CO2 value</div>\n";
 
ptr +="<div class=\"side-by-side coo\">";
